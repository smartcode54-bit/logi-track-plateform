...
| [0003](0003-edit-forms-fail-loudly-on-legacy-docs.md) | Edit forms fail loudly on legacy docs (never relax the schema to make old data saveable) | Accepted 2026-07-17 (dev verified; prod fn only, client pending) |
